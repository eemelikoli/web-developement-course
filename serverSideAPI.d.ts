...
declare class GlideAggregate
{
     ...
     * Adds an aggregate.
     * 
     * Available Aggregates: COUNT, SUM, MIN, MAX, AVG
     * @param agg Name of the aggregat, available: COUNT, SUM, MIN, MAX, AVG
     ...
     * 
     * Intervals available: Year, Quarter, Date, Week, DayOfWeek, Hour, Value.
     * @param fieldName 	The name of the field for which trending should occur.
     * @param timeInterval The time interval for the trend. Available: Year, Quarter, Date, Week, DayOfWeek, Hour, Value.
     */
     ...
     * Available Aggregates: COUNT, SUM, MIN, MAX, AVG
     * @param agg Type of aggregation. Available Aggregates: COUNT, SUM, MIN, MAX, AVG
